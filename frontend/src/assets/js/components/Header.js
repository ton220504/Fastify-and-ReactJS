...
class Header extends Component {
  ...
  getWishlistCount() {
    axios
      .get("/api/product/wishlist/count", {
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      })
      .then((result) => {
        ...
        <div id="top-header">
          <div className="container">
            <ul className="header-links">
              <li>
                <a href="#">
                  <i className="fa fa-phone"></i> +111-11-11-11
                </a>
              </li>
              <li>
                <a href="#">
                  <i className="fa fa-envelope-o"></i> bugbusters@email.com
                </a>
              </li>
              <li>
                <a href="#">
                  <i className="fa fa-map-marker"></i> 10000 Pristina
                </a>
              </li>
            </ul>
            <ul className="header-links">
