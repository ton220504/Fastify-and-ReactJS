            ...
            <div className="Top-header">
                <div className="container">
                    <div className="row align-items-center">
                        <div className={`${isMobile ? 'col-4' : 'col-xl-2 col-lg-2 col-md-12 col-sm-12 col-xs-12 col-12'} header-logo`}>
                            <Link to={"/"}>
                                <img className="img-header" 
                                    src="https://bizweb.dktcdn.net/100/497/960/themes/923878/assets/logo.png?1719291840576" alt="Logo" />
                            </Link>
                        </div>
                        <div className={`${isMobile ? 'col-8' : 'col-xl-7 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12'} position-relative`}>
